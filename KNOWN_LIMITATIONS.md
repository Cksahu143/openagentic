...
- The embedded code runner executes synchronous JavaScript in an isolated QuickJS runtime. Python, package installation, native binaries, and long-running processes require the separately hosted execution service.
